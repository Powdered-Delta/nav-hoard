...
const catalogs: Record<SupportedLocale, Record<string, string>> = {
  'zh-CN': {
    ...
    'home.search.heading': '先搜索，再决定要不要筛选',
    'home.search.summary': '优先搜索，必要时再筛选；主列表默认直接展示推荐与最新内容。',
    'home.search.placeholder': '搜索标题、摘要或标签，例如 React、浏览器、编译器…',
    'home.search.quick_placeholder': '快速搜索标题、摘要或标签…',
  ...
  en: {
    ...
    'home.search.summary': 'Search first and filter only when needed. The main list shows featured and fresh content by default.',
    ...
    'home.topbar.title': 'Public Link Collection',
    'home.topbar.about_open': 'Hide details',
    'home.topbar.about_closed': 'About this site',
    ...
    'editor.summary.form_hint': 'Save will normalize URLs, clean tags, deduplicate, validate, and publish runtime data.',
